...
import { guardSelectors, poiSelectors, useGameState } from '@/state/useGameState';
...
export const Combat = () => {
  ...
  const enemyGroup = useGameState(
    selectedPoiId ? guardSelectors.selectGuardByPoiId(selectedPoiId) : () => [],
  );
